...
#setwd("/Users/kristen/Documents/sshfs_dir/RankL_ablation/timepoint1")
...
#load("analysis_outs/seurat_timepoint1_empty.rda")
...
# Determine dims use from the jackstraw output
mtec <- group_cells(mtec, dims_use = 1:12)

# Change this based on your data!!!
stage_list <- c("0" = "Ccl21a_high", "1" = "Ccl21a_high", "2" = "Cortico_medullary",
                "3" = "Ccl21a_high" , "4" = "Tuft", "5" = "Aire_positive",
                "6" = "Late_Aire")  
