# This script is used to analyze the cells from the second timepoint
...
#setwd("/Users/kristen/Documents/sshfs_qian/timepoint2")
...
#load("analysis_outs/seurat_timepoint2_empty.rda")
#pdf("analysis_outs/timepoint2_images.pdf")
...
# Determine dims use from the jackstraw plot
mtec <- group_cells(mtec, dims_use = 1:12)

# Change this based on your data!!!
#mtec <- change_clus_ids(mtec, new_ids = c(4, 5, 2, 1, 3, 0, 6, 8, 7))

# Change this based on your data!!! For timepoint 2 I'm not very certain about them
stage_list <- c("0" = "Ccl21a_high", "1" = "Cortico_medullary", "2" = "Ccl21a_high",
                "3" = "Ccl21a_high" , "4" = "Ccl21a_high", "5" = "Aire_positive",
                "6" = "Ccl21a_high", "7" = "Tuft")
